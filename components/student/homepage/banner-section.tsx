    ...
    <section className="section-container h-[80vh] flex items-center justify-around">
      ...
      <div className="relative lg:w-[800px] h-[189px] ml-24">
        <h1 className=" text-[40px]  leading-[70px] font-semibold text-textSecondary">
          ...
          Tutors to Satisfy <br />
          Your Query
        </h1>
        <h1 className="text-3xl font-bold text-textSecondary mt-2 mb-6"> </h1>

        {/* group off button */}

        <div className="w-[100%] h-[76px] relative">
          <button className="btnAccent rounded-l-full border-white border-r-2">
            class{" "}
          </button>
          ...
          <button className="btnPrimary h-10 w-32 rounded-bl-full rounded-r-full absolute right-10">
            search
          </button>
        </div>
      </div>
